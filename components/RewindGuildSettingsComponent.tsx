...
export default function RewindGuildSettingsComponent() {
    ...
    const handleSave = async () => {
        ...
        const res = await fetch("/api/settings/rewind", {
            method: "POST",
            headers: { "Content-Type": "application/json" },
            body: JSON.stringify({ guildId, config: parsed }),
        });
            ...
            <div className="bg-[#141826] border border-[#1f2435] rounded-2xl shadow-lg p-6 space-y-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <InfoRow
                        ...
                        value={
                            <textarea
                                placeholder='{ rewind: {guildID: "", channelID: ""}}'
                                value={configText}
